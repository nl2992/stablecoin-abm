...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/11_balance_sheet_gate.png}
\caption{The paper in one decision. Facing the same SVB crisis and the same
single-venue backstop budget, a supervisor who acts on the correlational hub
ranking protects BUSD and a supervisor who acts on the causal counterfactual
protects USDC. A single public-disclosure check, whether any stablecoin holds
the venue as documented reserves, separates the two. BUSD holds no such role and
its protection removes $0\%$ of the contagion, while USDC is the origin and its
protection removes $100\%$. The numbers are the calibrated knockout results of
...
The budget comparison is the headline (Figure~\ref{fig:interventions}, summarised as a single decision
in Figure~\ref{fig:gate}). A regulator who can backstop
...
balance-sheet gate in Figure~\ref{fig:gate} is the one check that separates the two outcomes,
namely whether any stablecoin holds the protected venue as documented reserves.
